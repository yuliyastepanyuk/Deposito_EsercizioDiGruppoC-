        ...
        while (!exit)
        {
            ...
            switch (menuAction)
            {
                ...
                case 6:
                    ...
                    {
                        if (c.Docente.ToLower() == docente.ToLower())
                        {
                            Console.Write(c.NomeCorso);
                        }
                    }
                    break;
                ...
                case 7:
                    ...
                    sceltaCorso = Console.ReadLine();
                    indexCorso = int.Parse(sceltaCorso);
                    corsi[indexCorso].MetodoSpeciale();
                    break;
            }
        }
    }
